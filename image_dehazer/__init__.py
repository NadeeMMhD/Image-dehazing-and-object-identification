...
test_net = tf.keras.models.load_model(r'D:\TKMCE\dehaze_object\dehaze_object\Single-Image-Dehazing-Python-master\trained_model', compile = False)
...
class image_dehazer():
    ...
    def __psf2otf(self, psf, shape):
        ...
        return otf
    # def enhance_with_nn(self, img):
    #     if self.test_net is None:
    #         raise ValueError("TensorFlow model not provided")

    #     enhanced_img = self.test_net.predict(img)
    #     return enhanced_img
...
def remove_haze(HazeImg, airlightEstimation_windowSze=15, boundaryConstraint_windowSze=3, C0=20, C1=300,
    ...
    # enhanced_image = Dehazer.enhance_with_nn(HazeImg)
